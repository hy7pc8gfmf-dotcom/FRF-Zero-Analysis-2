...
Proof.
  intros S1 S2 map.
  (* Use identity uniqueness via concept identity *)
  ...
  - split.
    + intro x; unfold core_function in *; simpl.
      (* This requires more context; for now, assume it holds by design *)
      admit.
    + apply Forall2_refl.
Admitted.
...
Proof.
  ...
  (* This theorem as stated is problematic; likely needs refinement.
     For now, we keep the structure but note the issue. *)
  admit.
Admitted.
...
Proof.
  ...
  split; intro H; admit. (* Requires detailed axiom preservation proof *)
Admitted.
