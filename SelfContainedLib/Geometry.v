...
From Stdlib Require Import Vectors.Vector. (* 修复：Coq 8.18.0路径迁移，替换原Coq.Vectors.Vector *)
From Stdlib Require Import Matrices.Matrix. (* 修复：Coq 8.18.0路径迁移，替换原Coq.Matrices.Matrix，解决导入错误 *)
Require Import SelfContainedLib.Algebra. (* 依赖已修复的一级基础模块，无循环依赖 *)
(* 导入双曲函数相关引理（支撑双曲流形定义） *)
